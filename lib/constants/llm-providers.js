...
export const PROVIDER_API_KEY_RETRIEVE_URL = {
  ...
  "anthropic-sonnet": "https://console.anthropic.com/settings/keys",
...
// --------------------------------------------------------------------------
// Updated August 2026
// [GPT-5.6 Sol] Task: default OpenAI requests to the newest available ChatGPT model
...
// --------------------------------------------------------------------------
// Updated April 2026 based on https://platform.claude.com/docs/en/about-claude/models
export const ANTHROPIC_TOKEN_LIMITS = {
  // Latest models (Claude 4.6 family)
  "claude-opus-4-6": 200 * KILOBYTE * TOKEN_CHARACTERS,
  "claude-sonnet-4-6": 200 * KILOBYTE * TOKEN_CHARACTERS,
  // Claude 4.5 family
...
// --------------------------------------------------------------------------
// Updated April 2026 based on https://ai.google.dev/gemini-api/docs/models/gemini
export const GEMINI_TOKEN_LIMITS = {
  // Gemini 3 family
  "gemini-3.5-flash-lite": 1024 * KILOBYTE * TOKEN_CHARACTERS,
  "gemini-3.8-flash": 1024 * KILOBYTE * TOKEN_CHARACTERS,
  ...
  "gemini-3.1-pro-preview": 1024 * KILOBYTE * TOKEN_CHARACTERS,
...
// --------------------------------------------------------------------------
// Updated April 2026 based on https://docs.x.ai/docs/models
export const GROK_TOKEN_LIMITS = {
  ...
  "grok-4.3": 256 * KILOBYTE * TOKEN_CHARACTERS,
  "grok-4.20": 256 * KILOBYTE * TOKEN_CHARACTERS,
...
// --------------------------------------------------------------------------
// Updated August 2026 based on https://platform.openai.com/docs/models
export const OPENAI_TOKEN_LIMITS = {
  "gpt-5.6": 400 * KILOBYTE * TOKEN_CHARACTERS,
  "gpt-5.5": 400 * KILOBYTE * TOKEN_CHARACTERS,
  "gpt-5.4": 400 * KILOBYTE * TOKEN_CHARACTERS,
...
// --------------------------------------------------------------------------
// The model each provider should be asked for when a caller needs an answer inside a short timeout rather than the
// best answer available. These are the speed-tier models, not the provider's default, which is tuned for quality and
// can deliberate well past a one-minute budget. Providers absent from this map have no fast tier worth naming, and a
// caller resolving against them falls back to PROVIDER_DEFAULT_MODEL.
export const PROVIDER_FAST_MODEL = {
  anthropic: "claude-haiku-4-5",
  "anthropic-sonnet": "claude-haiku-4-5",
...
// --------------------------------------------------------------------------
// OpenAI's speed tier is a reasoning model rather than a separate small model, so unlike the other entries above it
// only behaves as a speed tier when its reasoning budget is capped. Left at its default it deliberates, which is how
// a sixty-second wizard pass was spent on a request that never returned. Only OpenAI reads this field.
export const FAST_TIER_REASONING_EFFORT = "low";

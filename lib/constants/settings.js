...
export const SETTING_KEYS = {
  ...
  COMPONENTS_SEEN: "dashboard_components_seen",
...
export const WIDGET_REGISTRY = [
  ...
  { widgetId: "graveyard",   name: "Task Graveyard",        description: "Surface neglected tasks and retire them to an archived graveyard note",
    icon: "⚰️", defaultGridWidthSize: 1, introducedAt: "2026-05-09", maxHorizontalTiles: 2, maxVerticalTiles: 2 },
];

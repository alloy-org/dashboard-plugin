...
export const WIDGET_REGISTRY = [
  ...
  { widgetId: "peak-hours",   name: "Peak Hours",          description: "Hourly distribution of task creation and completion activity",
    icon: "⏰", defaultGridWidthSize: 2, maxHorizontalTiles: 4, maxVerticalTiles: 2 },
  { widgetId: "energy-per-habit", name: "Energy Per Habit", visibleTitle: "Mood delta per habit",
    description: "Correlate each recurring-task habit with your mood: average mood on days you do it vs. days you don't",

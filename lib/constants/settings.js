...
export const IS_DEV_ENVIRONMENT = typeof process !== "undefined" && process.env?.NODE_ENV === "development";
...
export const PLANNING_NOTE_TAG_LABEL = "Tag to apply to planning notes";
...
export const WIDGET_REGISTRY = [
  ...
  { widgetId: "quick-actions", name: "Quick Actions",      description: "Shortcuts for your most frequently used dashboard actions",
    icon: "⚡", defaultGridWidthSize: 1, maxHorizontalTiles: 2, maxVerticalTiles: 2 },
  { widgetId: "dream-task",    name: "DreamTask",           description: "AI-suggested tasks aligned with your quarterly and monthly goals",
    icon: "💡", defaultGridWidthSize: 2, maxHorizontalTiles: 4, maxVerticalTiles: 2 },
];

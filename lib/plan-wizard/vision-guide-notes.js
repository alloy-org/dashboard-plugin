...
// @returns {Error} Error with a stable code so optional readers can skip incompatible guide data.
...
function unsupportedSchemaError(metadata, noteHandle) {
  ...
  return Object.assign(new Error(message), { code: "VISION_GUIDE_UNSUPPORTED_SCHEMA" });
}

...
// Bound writes conservatively below both published API size limits.
export async function replaceGuideSection(app, content, noteHandle, section) {
  if (content.length > 90000) throw new Error("Vision Guide section exceeds the supported size; split or archive its records");

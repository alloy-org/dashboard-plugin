...
export const PROSPECTS_PER_CATEGORY = 4;
...
export function prospectPromptFromEvidence(evidence, scope) {
  ...
  const sections = [
    ...
    `Propose at most ${ PROSPECTS_PER_CATEGORY } professional and ${ PROSPECTS_PER_CATEGORY } personal projects. `
      + "Propose fewer, or none, rather than padding the list with candidates the evidence does not support.",

...
import { PROSPECT_TASK_BUCKET_LABELS, appendProspectMonthSubtree, guideHeadingRanges, guideSectionRange,
  intentRootMarkdown, intentSectionDefinition, jsonPayloadMarkdown, parseJsonPayload, prospectFocusMonthLabel,
  prospectMonthAnchorHeading, prospectMonthHeadingText, prospectMonthSubtreeMarkdown, prospectPlacementBucketLabel,
  prospectRootMarkdown, prospectTaskBucketHeadingText, replaceJsonPayload } from "plan-wizard/vision-guide-markdown";
...
async function ensureProspectMonthSection(app, destinationLabel, guide, payload, prospect, scope) {
  ...
  const anchor = prospectMonthAnchorHeading(indexText, parentBody);

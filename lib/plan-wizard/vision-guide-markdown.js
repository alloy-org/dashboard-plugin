...
// @param {string} indexHeadingText - The category ideas & prospects heading, which holds every stored record and
//   is therefore never used as the anchor.
...
export function prospectMonthAnchorHeading(indexHeadingText, parentBody) {

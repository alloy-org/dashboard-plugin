...
//   timeoutSeconds }. reasoningEffort reaches only the direct provider leg; Agent Pro runs the model on its own
//   terms and takes no such field.
...
export async function raceWizardPrompt(app, prompt, { aiModel, apiKey, jsonResponse, reasoningEffort,
  timeoutSeconds } = {}) {

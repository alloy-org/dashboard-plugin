...
import { intentEvidenceDiagnostics, logPromptOutcome,
  logPromptSubmission } from "plan-wizard/wizard-prompt-diagnostics";
...
export async function inferIntentPossibilities(app, evidence, scope, { promptRunner = llmPromptWithPluginFallback } = {}) {
  ...
  const sizeDiagnostics = logPromptSubmission(INFERENCE_LOG_LABEL, { model: WIZARD_LLM_MODEL, prompt,

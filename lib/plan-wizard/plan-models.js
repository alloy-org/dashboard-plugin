...
export const PROSPECT_PRIORITIES = ["backburner", "monthFocus", "notNow", "opportunistic", "quarterFocus", "stayWarm"];
...
// @property {string} priority - Focus/deferral decision; legacy opportunistic and backburner values remain readable.

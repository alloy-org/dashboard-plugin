...
import { consolidatePlanActionProspects, readPlanGoals, refreshPlanActionProspects, refreshPlanIntentPossibilities,
  savePlanGoals, savePlanProspects, savePlanQuarterAnswer } from "plan-wizard/plan-wizard-service";
...
export default function usePlanWizard({ app, domainName = null, domainUuid = null, quarter = null, year = null }) {
  ...
  return { consolidateProspects, discoverProspects, discoveryFailureReason, error, isConsolidating, isDiscovering,
    isLoading, isRefreshing, isSaving, planningContext, refreshPossibilities, reload, saveError, saveGoals,
    saveProspectDecision, saveProspects, saveQuarterAnswer, viewQuarterlyPlan };
}

...
import { parseComponentsSeen } from "util/new-component-popin"
...
async function _readDashboardSettings(app) {
  ...
  settings[SETTING_KEYS.COMPONENTS_SEEN]       = parseComponentsSeen(app.settings[SETTING_KEYS.COMPONENTS_SEEN]);

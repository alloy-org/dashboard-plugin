      ...
      switch (actionType) {
        ...
        default:
          if (typeof app[actionType] === "function") {
            if (actionType === "attachNoteMedia") {
              logIfEnabled(`[plugin] attachNoteMedia called — uploading background image to plugin note`);
              const result = await app[actionType](...args);

...
export default function ConfigPopup({ title, onSubmit, onCancel, children }) {
  ...
  return h('div', { className: 'config-popup-overlay', onClick: handleOverlayClick },
    h('div', { className: 'config-popup' },
      ...
      h('div', { className: 'config-popup-actions' },
        ...
        h('button', { className: 'config-popup-btn config-popup-btn--submit', onClick: onSubmit }, 'Submit')
      )
    )
  );
}

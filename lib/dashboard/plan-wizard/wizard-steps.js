...
// step to its code without searching. The projects step is built but its discovery milestone is not: the page
// captures projects the user names and is ready to show inferred proposals alongside them once
// prospect-discovery.js exists.
...
export const WIZARD_STEPS = [
  ...
  { key: "themed-weekdays", title: "Would themed weekdays make choosing tasks easier?",
    ...
    implementationFile: "lib/dashboard/plan-wizard/themed-weekdays-step.jsx" },

...
export const WIZARD_STEPS = [
  {
    ...
    key: "intent",
    summary: "What's the big picture outcome you want to achieve? Your high-level intent drives suggestions generated later.",
  ...
  {
    implementationFile: "lib/dashboard/plan-wizard/done-enough-step.jsx",
    key: "enough-for-today",
    summary: "Let Amplenote recognize a high-value day so \"one more task\" doesn't become the default.",
    title: "When have you done enough for today—and what would you rather do next?"
  },
];

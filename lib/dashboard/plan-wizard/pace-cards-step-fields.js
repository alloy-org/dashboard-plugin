...
export const PACE_OPTIONS = [
  ...
  { defaultWeekdays: ["wednesday"], label: "One substantial block per week", value: "oneSubstantialBlock" },
...
//   mid-week day for a substantial block, every workday for a small daily move, and none for a sprint or
//   maintenance rhythm. The user can then click days on or off from that starting set.
...
// ----------------------------------------------------------------------------------------------
// @desc Add or remove one weekday. A substantial weekly block keeps only the day just clicked, so choosing

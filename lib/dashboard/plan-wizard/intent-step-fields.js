...
// @param {string} userCategoryEm - work or personal.
// @returns {object} New draft field, marked so the intent page focuses it as soon as it mounts.
export function nextSecondaryRank(draftFields, userCategoryEm) {
  ...
  return { ...emptyField(highestRank + 1, userCategoryEm), shouldAutoFocus: true };
}

...
//   Vision Guide), because every line of it is generated and no part of it is user-authored. Existing tasks
//   render as plain-text links without their Rich Footnotes: the link already leads to the task, where the
//   footnotes (captions, images) remain intact, so copying them here would only duplicate them.

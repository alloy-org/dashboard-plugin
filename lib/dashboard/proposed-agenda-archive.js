...
// [Claude claude-opus-4-8 (1M context)] Task: persist targetMidnightSeconds so a cached future-day agenda still
//   schedules onto its target day rather than today
...
// [Claude claude-opus-4-8 (1M context)] Task: restore targetMidnightSeconds for cached future-day scheduling
function activityFromPersistedEntry(entry) {
  return { durationMinutes: entry.durationMinutes || 0, isExisting: !!entry.isExisting, noteUuid: entry.noteUuid || null,
    ...
    targetMidnightSeconds: entry.targetMidnightSeconds ?? null, taskUuid: entry.taskUuid || null, title: entry.title };
}

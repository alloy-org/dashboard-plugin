...
// [Claude] Task: root component with split state, useDomainTasks, and useCompletedTasks hooks
// Prompt: "call fetchCompletedTasks on mount and domain change, pass to VictoryValue"
...
export default function DashboardApp() {
  ...
  // Re-fetch when the active task domain changes so VictoryValue stays current
  useEffect(() => {
    if (activeTaskDomain) fetchCompletedTasks();
  }, [activeTaskDomain]);

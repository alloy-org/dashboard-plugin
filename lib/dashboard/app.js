...
// [Claude] Task: root component — fetch data via callPlugin('init') and render widget grid
// Prompt: "main React component that calls init, shows loading/error, and lays out widgets"

...
function renderActiveComponents(createElementFunction, dashboardData, { selectedDate, onDateSelect } = {}) {
...
export default function DashboardApp() {
  ...
  return h('div', { className: 'dashboard' },
    ...
    h('div', { className: 'dashboard-grid' },
      ...renderActiveComponents(h, data, { selectedDate, onDateSelect: setSelectedDate })
    )
  );
}

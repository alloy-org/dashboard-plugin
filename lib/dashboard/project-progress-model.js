...
export function projectProgressEvidence(project, targetDate, { focusDate = targetDate } = {}) {
  ...
  const reason = blocksPerWeek
    ...
    : `${ project.summary } has no chosen weekly pace, so it ranks below projects that have one.`;

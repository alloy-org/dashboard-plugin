...
export default function DashboardSettingsPopup({
  ...
  console.log('[settings-popup] rendering DashboardSettingsPopup, currentBackgroundImageUrl:', currentBackgroundImageUrl);
  ...
  return h(ConfigPopup, {
    ...
    onSubmit: () => onSave({ llmProvider: selectedProvider, apiKey, backgroundMode }),
    onCancel,
              ...
              : backgroundImageUrl
                ? h('div', { className: 'dashboard-settings-dropzone-preview' },
                    h('img', {
                      ...
                      onLoad: () => console.log('[settings-popup] background preview image loaded OK:', backgroundImageUrl),
                      onError: (e) => console.error('[settings-popup] background preview image FAILED to load:', backgroundImageUrl, e.type),
                    }),

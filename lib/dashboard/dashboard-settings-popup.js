...
// [Composer] Task: single outer `.section` wrapper so dividers apply to full block
// Prompt: "delineation between sections — section class on outer container"
// Date: 2026-04-09
function renderAiProviderSection(h, { apiKey, apiKeyVisible, linkParenthetical, note, onApiKeyChange, onProviderChange,
  ...
  return h('div', { className: 'dashboard-settings-section section' },

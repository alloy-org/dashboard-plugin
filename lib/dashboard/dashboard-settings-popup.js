...
// [Claude] Task: convert a File to a data URL for use with app.attachNoteMedia
...
// Prompt: "add background image upload option to DashboardSettings with display mode selector and remove link"
// Date: 2026-03-01 | Model: claude-4.6-opus-high-thinking
export default function DashboardSettingsPopup({
  ...
  const [backgroundMode, setBackgroundMode] = useState(currentBackgroundMode || 'cover');

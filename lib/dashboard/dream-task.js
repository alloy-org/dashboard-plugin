...
// [Claude] Task: render task title and explanation using Amplenote markdown
...
function renderTaskList(h, tasks, maxTasks, headerActions, noteUUID, onTaskClick, listRef) {
...
export default function DreamTaskWidget({ app, gridHeightSize = 1, gridWidthSize = 1, onOpenSettings }) {
  ...
  return renderTaskList(h, tasks, maxTasks, headerActions, noteUUID, onTaskClick, listRef);
}

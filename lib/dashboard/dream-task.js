...
// Date: 2026-03-14 | Model: claude-sonnet-4-6
function renderTaskList(h, tasks, maxTasks, headerActions, goalsSummary, noteUUID, onTaskClick) {
...
export default function DreamTaskWidget({ app, gridHeightSize = 1, gridWidthSize = 1, onOpenSettings }) {
  ...
  return renderTaskList(h, tasks, maxTasks, headerActions, goalsSummary, noteUUID, onTaskClick);
}

...
// Date: 2026-03-14 | Model: claude-4.6-sonnet-medium-thinking
// [Claude] Task: accept llmApiKey prop so widget retries when a new API key is added
...
export default function DreamTaskWidget({ app, gridHeightSize = 1, gridWidthSize = 1, llmApiKey: llmApiKeyProp, onOpenSettings }) {
  ...
  const llmApiKey = llmApiKeyProp || app.settings?.[SETTING_KEYS.LLM_API_KEY];

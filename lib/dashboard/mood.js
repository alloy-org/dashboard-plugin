...
import { DASHBOARD_NOTE_TAG, widgetTitleFromId, parseWidgetConfig } from "constants/settings";
...
export default function MoodWidget({ app, moodRatings, onMoodRecorded }) {
  ...
  const handleConfigureSubmit = () => {
    ...
    app.setSetting('dashboard_mood_config', JSON.stringify([pendingVisualizationMode]));
  };

...
export default function DashboardApp({ app }) {
  ...
  const handleLayoutSave = useCallback(
    async (newRenderedWidgetIds, isReset = false, sizing = null) => {
      await handleLayoutPersist(newRenderedWidgetIds, isReset, sizing);
      setFocusState(DASHBOARD_FOCUS.DEFAULT);
    },
    [handleLayoutPersist]
  );
        ...
        h('div', {
          ...
          ...displayedComponents.map((config, index) => {
            ...
            return h(CellComponent, {
              ...
              currentLayout: configParams?.[SETTING_KEYS.DASHBOARD_COMPONENTS] || DEFAULT_DASHBOARD_COMPONENTS,

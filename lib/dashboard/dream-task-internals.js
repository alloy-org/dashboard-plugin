...
// ----------------------------------------------------------------------------------------------
// @desc Returns the number of task cards to display: (widthCells × heightCells) + 1.
...
// [Claude claude-4.6-opus-high-thinking] Task: compute maxTasks as (widthCells * heightCells) + 1
// Prompt: "tasks generated should equal (heightCells * widthCells) + 1 instead of magic numbers"

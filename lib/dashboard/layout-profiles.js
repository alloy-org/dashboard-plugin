...
export const LAYOUT_PROFILES = [
  ...
  },
  {
    ...
    widgets: [
      ...
      { widgetId: 'quotes',        gridWidthSize: 2 }, // Row 3
      { widgetId: 'recent-notes',  gridWidthSize: 2 },
      { widgetId: 'peak-hours',    gridWidthSize: 2 }, // Row 4
      { widgetId: 'shared-notes',  gridWidthSize: 2 }, // Row 5
    ],
  },
  {
    id: 'mindful-achiever',
    ...
    widgets: [
      ...
      { widgetId: 'dream-task',    gridWidthSize: 2 }, // Row 3
      { widgetId: 'calendar',      gridWidthSize: 2 },
      { widgetId: 'victory-value', gridWidthSize: 2 }, // Row 4
    ],
  },
];

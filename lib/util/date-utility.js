...
// [OpenAI GPT-5.5] Task: DRY local-midnight derivation across calendar and agenda utilities
...
// [Claude claude-opus-4-8 (1M context)] Task: shared local `YYYY-MM` month key for month-scoped widgets and navigation
// Prompt: "use lib/util/date-utility.js ... create a new function if there's nothing similar"
// Date: 2026-07-19 | Model: claude-opus-4-8 (1M context)
// Builds a local calendar month key (`YYYY-MM`) from date-like input.
// @example
// monthKeyFromDateInput(new Date('2026-07-19')) // '2026-07'
...
// [Claude claude-opus-4-8 (1M context)] Task: parse a `YYYY-MM` month key back into a local Date at the month's first day
// Prompt: "use lib/util/date-utility.js ... create a new function if there's nothing similar"
// Date: 2026-07-19 | Model: claude-opus-4-8 (1M context)
// Parses a local `YYYY-MM` month key into a `Date` at midnight on the first day of that month.
// @example
// dateFromMonthKey('2026-07') // Date for 2026-07-01T00:00 local
...
// [Claude claude-opus-4-8 (1M context)] Task: shift date-like input to the first day of the month `offset` months away
// Prompt: "use lib/util/date-utility.js ... create a new function if there's nothing similar"
// Date: 2026-07-19 | Model: claude-opus-4-8 (1M context)
// Returns the first day of the month `monthOffset` months from the input date (negative steps backward).
// @example
// monthStartFromDateInput('2026-07-19', -1) // Date for 2026-06-01T00:00 local
...
// [Claude claude-opus-4-8 (1M context)] Task: minute-aware clock label shared by proposed-agenda
// Prompt: "reuse date-utility for _formatStartLabel"
// Formats minutes-since-midnight as a clock label, respecting time format preference.
// @example
// formatClockLabel(570)         // "9:30 AM"

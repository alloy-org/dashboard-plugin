...
function _showSimplePromptModal(message, options = {}) {
  ...
  return new Promise((resolve) => {
    ...
    // The panel mirrors .config-popup-container: card background, hairline border, 14px radius, and a
    // header/body/actions split separated by rules rather than one undivided box of controls.
